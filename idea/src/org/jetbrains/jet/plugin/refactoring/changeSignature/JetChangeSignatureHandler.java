...
import static org.jetbrains.jet.plugin.refactoring.changeSignature.JetChangeSignature.run;
...
public class JetChangeSignatureHandler implements ChangeSignatureHandler {
    ...
    public static void invokeChangeSignature(
        ...
        run(project, functionDescriptor, emptyConfiguration(), bindingContext, context, null, false);
    }

    @TestOnly
    public static JetChangeSignature.ChangeSignatureConfiguration getConfiguration() {
        return emptyConfiguration();
    }

    private static JetChangeSignature.ChangeSignatureConfiguration emptyConfiguration() {
        return new JetChangeSignature.ChangeSignatureConfiguration() {
            @Override

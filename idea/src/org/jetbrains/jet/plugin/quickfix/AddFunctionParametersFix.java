...
public class AddFunctionParametersFix extends ChangeFunctionSignatureFix {
    ...
    protected void invoke(@NotNull Project project, Editor editor, JetFile file) {
        ...
        run(project, functionDescriptor, addParameterConfiguration(), bindingContext, callElement, getText(), performSilently);
    }

    private JetChangeSignature.ChangeSignatureConfiguration addParameterConfiguration() {

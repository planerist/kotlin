...
import org.jetbrains.jet.plugin.refactoring.changeSignature.JetChangeSignature;
...
public class ChangeFunctionLiteralSignatureFix extends ChangeFunctionSignatureFix {
    ...
    protected void invoke(@NotNull final Project project, Editor editor, JetFile file) {
        ...
        run(project, functionDescriptor, new JetChangeSignature.ChangeSignatureConfiguration() {
            @Override
